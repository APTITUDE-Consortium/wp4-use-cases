...
Security Checkpoint - The traveller can: 

1)	Select the proximity sharing option in his wallet (ISO 18013-5) if the self-service check point is providing the proximity verification option and share required attributes 

2)	Or scan the Ready to travel QR code attributes at a self-service baggage drop kiosk (Marseille Baggage drop Kiosk)

A facial recognition module verifies the traveller against the stored biometric template.

Upon successful verification, the traveller proceeds through security control.
...
<img width="741" height="572" alt="image" src="https://github.com/user-attachments/assets/be478c48-5ff9-4911-b6bc-504f3688ecb0" />
...
* Estimated time optimization on security identity check up to 30%
